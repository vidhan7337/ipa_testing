  ...
  Future<void> addSeats() async {
    ...
    try {
      await Provider.of<SeatProvider>(
        context,
        listen: false,
      ).addseat(currentLibraryId!, seatNumber, selectedSeries);
      if (!mounted) return;
      AppSnackbar.showSnackbar(
        context,
        '$seatNumber seats added successfully to Series $selectedSeries',
        AppColors.successColor,
      );
      _seatNumberController.clear();
      Navigator.pop(context);
    } catch (_) {
      _showToast("Failed to add seats. Please try again.");
    } finally {
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 16),
                AppButton(
                  text: 'Add Seats to Series $selectedSeries',
                  onPressed: () {
